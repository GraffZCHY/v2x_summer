...
static const _CAN_type_support_symbol_names_t _CAN_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, perception_comm, msg, CAN)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, perception_comm, msg, CAN)),
  }
};
...
{
  return &::perception_comm::msg::rosidl_typesupport_cpp::CAN_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, perception_comm, msg, CAN)() {
  return get_message_type_support_handle<perception_comm::msg::CAN>();
}

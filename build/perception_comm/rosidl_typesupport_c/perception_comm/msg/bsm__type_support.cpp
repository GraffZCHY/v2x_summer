...
#include "perception_comm/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _BSM_type_support_symbol_names_t _BSM_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, perception_comm, msg, BSM)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, perception_comm, msg, BSM)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_perception_comm
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, perception_comm, msg, BSM)() {
  return &::perception_comm::msg::rosidl_typesupport_c::BSM_message_type_support_handle;
}

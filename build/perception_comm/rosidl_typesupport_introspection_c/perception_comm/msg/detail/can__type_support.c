...
void CAN__rosidl_typesupport_introspection_c__CAN_init_function(
...
void CAN__rosidl_typesupport_introspection_c__CAN_fini_function(void * message_memory)
{
  perception_comm__msg__CAN__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember CAN__rosidl_typesupport_introspection_c__CAN_message_member_array[21] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers CAN__rosidl_typesupport_introspection_c__CAN_message_members = {
  "perception_comm__msg",  // message namespace
  "CAN",  // message name
  21,  // number of fields
  sizeof(perception_comm__msg__CAN),
  CAN__rosidl_typesupport_introspection_c__CAN_message_member_array,  // message members
  CAN__rosidl_typesupport_introspection_c__CAN_init_function,  // function to initialize message memory (memory has to be allocated)
  CAN__rosidl_typesupport_introspection_c__CAN_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t CAN__rosidl_typesupport_introspection_c__CAN_message_type_support_handle = {
  0,
  &CAN__rosidl_typesupport_introspection_c__CAN_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, perception_comm, msg, CAN)() {
  CAN__rosidl_typesupport_introspection_c__CAN_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  if (!CAN__rosidl_typesupport_introspection_c__CAN_message_type_support_handle.typesupport_identifier) {
    CAN__rosidl_typesupport_introspection_c__CAN_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &CAN__rosidl_typesupport_introspection_c__CAN_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif

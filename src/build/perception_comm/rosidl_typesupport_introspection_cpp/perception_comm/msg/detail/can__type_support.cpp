...
void fetch_function__CAN__v2_x_intersection_s_p_a_t(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__v2_x_intersection_s_p_a_t(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__v2_x_intersection_s_p_a_t(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__v2_x_intersection_s_p_a_t(untyped_member, index));
...
void fetch_function__CAN__v2_x_intersection_m_a_p(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__v2_x_intersection_m_a_p(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__v2_x_intersection_m_a_p(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__v2_x_intersection_m_a_p(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__a_v_state(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__a_v_state(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__a_v_state(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__a_v_state(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__road_state(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__road_state(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__road_state(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__road_state(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__vehicle_orientation(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__vehicle_orientation(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__vehicle_orientation(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__vehicle_orientation(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__vehicle_location(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__vehicle_location(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__vehicle_location(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__vehicle_location(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__objects(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__objects(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__objects(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__objects(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__object_track_a(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__object_track_a(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__object_track_a(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__object_track_a(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__object_track_b(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__object_track_b(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__object_track_b(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__object_track_b(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__object_track_c(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__object_track_c(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__object_track_c(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__object_track_c(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__object_track_d(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__object_track_d(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__object_track_d(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__object_track_d(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__traffic_signal_heads(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__traffic_signal_heads(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__traffic_signal_heads(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__traffic_signal_heads(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__traffic_signal_head_track_a(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__traffic_signal_head_track_a(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__traffic_signal_head_track_a(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__traffic_signal_head_track_a(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__traffic_signs(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__traffic_signs(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__traffic_signs(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__traffic_signs(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__traffic_sign_track_a(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__traffic_sign_track_a(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__traffic_sign_track_a(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__traffic_sign_track_a(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__lane_markings(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__lane_markings(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__lane_markings(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__lane_markings(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__lane_marking_track_a(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__lane_marking_track_a(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__lane_marking_track_a(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__lane_marking_track_a(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__limit_lines(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__limit_lines(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__limit_lines(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__limit_lines(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__limit_line_track_a(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__limit_line_track_a(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__limit_line_track_a(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__limit_line_track_a(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__CAN__misc(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__CAN__misc(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__CAN__misc(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__CAN__misc(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CAN_message_member_array[21] = {
  ...
  },
  {
    ...
    fetch_function__CAN__v2_x_intersection_s_p_a_t,  // fetch(index, &value) function pointer
    assign_function__CAN__v2_x_intersection_s_p_a_t,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__v2_x_intersection_m_a_p,  // fetch(index, &value) function pointer
    assign_function__CAN__v2_x_intersection_m_a_p,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__a_v_state,  // fetch(index, &value) function pointer
    assign_function__CAN__a_v_state,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__road_state,  // fetch(index, &value) function pointer
    assign_function__CAN__road_state,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__vehicle_orientation,  // fetch(index, &value) function pointer
    assign_function__CAN__vehicle_orientation,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__vehicle_location,  // fetch(index, &value) function pointer
    assign_function__CAN__vehicle_location,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__objects,  // fetch(index, &value) function pointer
    assign_function__CAN__objects,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__object_track_a,  // fetch(index, &value) function pointer
    assign_function__CAN__object_track_a,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__object_track_b,  // fetch(index, &value) function pointer
    assign_function__CAN__object_track_b,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__object_track_c,  // fetch(index, &value) function pointer
    assign_function__CAN__object_track_c,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__object_track_d,  // fetch(index, &value) function pointer
    assign_function__CAN__object_track_d,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__traffic_signal_heads,  // fetch(index, &value) function pointer
    assign_function__CAN__traffic_signal_heads,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__traffic_signal_head_track_a,  // fetch(index, &value) function pointer
    assign_function__CAN__traffic_signal_head_track_a,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__traffic_signs,  // fetch(index, &value) function pointer
    assign_function__CAN__traffic_signs,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__traffic_sign_track_a,  // fetch(index, &value) function pointer
    assign_function__CAN__traffic_sign_track_a,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__lane_markings,  // fetch(index, &value) function pointer
    assign_function__CAN__lane_markings,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__lane_marking_track_a,  // fetch(index, &value) function pointer
    assign_function__CAN__lane_marking_track_a,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__limit_lines,  // fetch(index, &value) function pointer
    assign_function__CAN__limit_lines,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__limit_line_track_a,  // fetch(index, &value) function pointer
    assign_function__CAN__limit_line_track_a,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__CAN__misc,  // fetch(index, &value) function pointer
    assign_function__CAN__misc,  // assign(index, value) function pointer
